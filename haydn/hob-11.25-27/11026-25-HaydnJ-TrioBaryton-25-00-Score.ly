	...
	<< 		
			\new Staff \with {instrumentName = "Baryton" }
					<<	\keepWithTag #'mvtI {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-01-By-1.ily"}
					>>
			\new Staff \with {instrumentName = "Alto"}
					<<	\keepWithTag #'mvtI {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-02-A-1.ily"}
					>>
			\new Staff \with {instrumentName = "Violoncelle"}
					<<	\keepWithTag #'mvtI {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-03-Vc-1.ily"}
					>>
	>>
	...
	<< 		
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-01-By-2.ily"}
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-02-A-2.ily"}
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-03-Vc-2.ily"}
					>>
	>>
	...
	<< 		
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-01-By-3.ily"}
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-02-A-3.ily"}
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
							\keepWithTag #'score {\include "11026-25-03-Vc-3.ily"}
					>>
	>>
