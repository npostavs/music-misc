...
\score {    %%1er mvt
  ...
  { \silencesMulti
    <<  \keepWithTag #'mvtI { \include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily" }
      \keepWithTag #'partie { \include "11026-25-01-By-1.ily" }
    >>
  }
} %% fin score 1er mvt
\pageBreak
\score {    %%2e mvt
  ...
  { \silencesMulti
    <<  \keepWithTag #'mvtII {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
        \keepWithTag #'partie \include "11026-25-01-By-2.ily"
    >>
  }
} %%   fin score 2e mvt
...
\score {    %%3e mvt
  ...
  { \silencesMulti
    <<  \keepWithTag #'mvtIII {\include "11026-25-HaydnJ-TrioBaryton-25-Trame.ily"}
        \keepWithTag #'partie \include "11026-25-01-By-3.ily"
    >>
  }
} %%   fin score 3e mvt
...
\score {    %%1er mvt
  ...
  { \silencesMulti
    <<  \keepWithTag #'mvtI { \include "11026-27-HaydnJ-TrioBaryton-27-Trame.ily" }
      \keepWithTag #'partie { \include "11026-27-01-By-1.ily" }
    >>
  }
} %% fin score 1er mvt
...
\score {    %%2e mvt
  ...
  { \silencesMulti
    <<  \keepWithTag #'mvtII {\include "11026-27-HaydnJ-TrioBaryton-27-Trame.ily"}
        \keepWithTag #'partie \include "11026-27-01-By-2.ily"
    >>
  }
} %%   fin score 2e mvt
...
\score {    %%3e mvt
  ...
  { \silencesMulti
    <<  \keepWithTag #'mvtIII {\include "11026-27-HaydnJ-TrioBaryton-27-Trame.ily"}
        \keepWithTag #'partie \include "11026-27-01-By-3.ily"
    >>
  }
} %%   fin score 3e mvt
