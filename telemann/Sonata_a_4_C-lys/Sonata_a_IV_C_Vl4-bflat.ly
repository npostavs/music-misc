...
\header {
  ...
  subtitle = \markup {Violin IV (B\flat)}
...
%% NOTE: in language="deutsh", Bflat = b (and B = h)
...
\score {
  ...
  \transpose b c' \allegroIIAViolinIV
  \layout {
    \context {
      \Score \override SpacingSpanner.common-shortest-duration = #(ly:make-moment 1/1)
    }
