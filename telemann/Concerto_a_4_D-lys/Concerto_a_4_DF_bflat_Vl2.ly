...
\header {
  ...
  subtitle = \markup { "Violin II - B" \flat }
...
\score {
  ...
  \transpose b, c \transpose d f { \clef "treble^8" \adagioViolinII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose b, c \transpose d f { \clef "treble^8" \allegroViolinII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose b, c \transpose d f { \clef "treble^8" \graveViolinII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose b, c \transpose d f { \clef "treble" \allegroIIViolinII }
  \layout {
    indent = 6
  }
}
