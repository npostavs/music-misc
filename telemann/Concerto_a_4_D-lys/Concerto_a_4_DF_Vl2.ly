...
\score {
  ...
  \transpose d f { \clef "treble" \adagioViolinII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose d f { \clef "treble" \allegroViolinII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose d f { \clef "treble" \graveViolinII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose d f { \clef "treble" \allegroIIViolinII }
  \layout {
    indent = 6
  }
}
