...
\score {
  ...
  \transpose d f { \clef "alto^8" \adagioViolinIII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose d f { \clef "alto^8" \allegroViolinIII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose d f { \clef "alto^8" \graveViolinIII }
  \layout {
    indent = 6
  }
}
...
\score {
  ...
  \transpose d f { \clef "alto^8" \allegroIIViolinIII }
  \layout {
    indent = 6
  }
}
