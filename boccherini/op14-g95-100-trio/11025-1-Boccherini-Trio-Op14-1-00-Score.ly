	...
	<< 		
			\new Staff \with {instrumentName = "Violon" }
					<<	\keepWithTag #'mvtI {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-01-Vn-1.ily"}
					>>
			\new Staff \with {instrumentName = "Alto"}
					<<	\keepWithTag #'mvtI {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-02-A-1.ily"}
					>>
			\new Staff \with {instrumentName = "Violoncelle"}
					<<	\keepWithTag #'mvtI {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-03-Vc-1.ily"}
					>>
	>>
	...
	<< 		
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-01-Vn-2.ily"}
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-02-A-2.ily"}
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-03-Vc-2.ily"}
					>>
	>>
	...
	<< 		
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-01-Vn-3.ily"}
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-02-A-3.ily"}
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "11025-1-Boccherini-Trio-Op14-1-Trame.ily"}
							\keepWithTag #'score {\include "11025-1-03-Vc-3.ily"}
					>>
	>>
